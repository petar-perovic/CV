...
const skills = ['C++','C','C#','Java','Python','PHP','Javascript','Node.js','Html','CSS','PostgreSQL','MS SQL','MySQL','VS C# .NET','React','RabbitMQ','Bash', 'Angular', 'Spring Boot'];
const images = ['C++', 'c','csharp','java','python','php','js','node','html','css','postgresql','mssql','mysql','vs','react','rabbitmq','bash', 'angular', 'spring'];
const percent = [90,85,75,90,85,75,90,90,100,95,90,80,60,80,60,60,60,60,90];
